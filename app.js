...
var Questions = [
  ...
  
    {
      ...
      options: ["could be a  ", "was a", " would be", " is a"],
      answer: 3,
    },
  
    {
      question: "Generic is most similar in meaning to",
      options: ["Branded", "Basic", "Trademarked", "Specific  "],
      answer: 1,
    },
  
    {
      question: "What animal has the worst memory?",
      options: ["Dog", "Rat", "Elephant", "Dolphin"],
      answer: 2,
    },
  
    {
      question: "MS-Word is an example of _____",
      options: ["An operating system ", "A processing device", "Application software", "An input device"],
      answer: 2,
    },
  ];
